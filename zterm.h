/*
 * zterm.h — Shared types, constants, globals, and forward declarations
 *
 * Every translation unit includes this header.  It must be safe to include
 * multiple times (guard below) and must not contain any definitions — only
...
/* ── Global state (defined in their respective .c files) ───────────────── */
